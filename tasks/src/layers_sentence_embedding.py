...
from tasks.src.layers_attention import WordLevelAttention
from tasks.src.utils_general import get_config, freeze_all_params, format_layer_freezes, \
...
class SentenceEmbeddingsLayer(PretrainedModelLoader):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.config.sentence_embedding_method == 'multiheaded-attention':
            from tasks.src.layers_attention_tg import SentenceCompressor
